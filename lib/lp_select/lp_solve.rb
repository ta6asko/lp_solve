...
module LPSolve
  ...
  attach_function :add_column, [:pointer, :REAL], :void

  # void put_abortfunc(lprec *lp, lphandle_intfunc newctrlc, void *ctrlchandle)
  attach_function :put_abortfunc, [:pointer, :int, :void], :void

  # void set_constr_type(lprec *lp, int row, int con_type)
  attach_function :set_constr_type, [:pointer, :int, :int], :char

  # void set_int(lprec *lp, int column, unsigned char must_be_int))
  attach_function :set_int, [:pointer, :int, :string], :char

  # void set_rh(lprec *lp, int row, REAL value)
  attach_function :set_rh, [:pointer, :int, :REAL], :char
  ...
  attach_function :read_lp, :read_LP, [:string, :int, :string], :pointer
  ...
  attach_function :get_ncolumns, :get_Ncolumns, [:pointer], :int
